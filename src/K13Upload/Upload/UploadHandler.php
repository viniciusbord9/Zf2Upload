...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $additional_path_upload = null, $additional_url = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().$additional_url,
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$additional_path_upload,
            'upload_url' => $this->get_full_url().'/files/'.$additional_path_upload,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
